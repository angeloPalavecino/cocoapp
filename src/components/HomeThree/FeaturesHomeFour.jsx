                ...
                <div className="row">
                        ...
                        <div className="inner-box">
                            <div className="image-box">
                                <figure className="image">
                                    <Link to="/about-us"><img src={BenefitImage} alt="Banking" /></Link>
                                </figure>
                                <div className="title-box">
                                    <Link to="/about-us" className="read-more">
                                        <i className="icon fa fa-long-arrow-alt-right"></i>
                                    </Link>
                                    <h4 className="title"><Link to="/about-us">Banking</Link></h4>
                                </div>
                            </div>
                    ...
                    <div className="feature-block-two col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="300ms">
                        <div className="inner-box">
                            <div className="image-box">
                                <figure className="image">
                                    <Link to="/about-us"><img src={BenefitImage} alt="Networking" /></Link>
                                </figure>
                                <div className="title-box">
                                    <Link to="/about-us" className="read-more">
                                        <i className="icon fa fa-long-arrow-alt-right"></i>
                                    </Link>
                                    <h4 className="title"><Link to="/about-us">Networking</Link></h4>
                                </div>
                            </div>
                            <div className="content-box">
                                <div className="inner">
                    ...
                    <div className="feature-block-two col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="600ms">
                        <div className="inner-box">
                            <div className="image-box">
                                <figure className="image">
                                    <Link to="/about-us"><img src={BenefitImage} alt="Marketing" /></Link>
                                </figure>
                                <div className="title-box">
                                    <Link to="/about-us" className="read-more">
                                        <i className="icon fa fa-long-arrow-alt-right"></i>
                                    </Link>
                                    <h4 className="title"><Link to="/about-us">Marketing</Link></h4>
                                </div>
                            </div>
                            <div className="content-box">
                                <div className="inner">
                    ...
                    <div className="feature-block-two col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="900ms">
                        <div className="inner-box">
                            <div className="image-box">
                                <figure className="image">
                                    <Link to="/about-us"><img src={BenefitImage} alt="Education" /></Link>
                                </figure>
                                <div className="title-box">
                                    <Link to="/about-us" className="read-more">
                                        <i className="icon fa fa-long-arrow-alt-right"></i>
                                    </Link>
                                    <h4 className="title"><Link to="/about-us">Education</Link></h4>
                                </div>
                            </div>
                            <div className="content-box">
                                <div className="inner">
