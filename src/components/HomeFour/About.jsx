...
function AboutFour() {
    return (
        <section id="about" className="about-section-two">
                            ...
                            <div className="inner-column">
                                ...
                                <div className="bottom-box">
                                    <div className="author-box">
                                        <figure className="image"><img src={aboutThumb} alt="Aleesha brown" /></figure>
                                        <div className="info">
                        ...
                        <div className="image-column col-xl-6 col-lg-5 col-md-12 col-sm-12">
                            <div className="inner-column wow fadeInLeft">
                                <div className="image-box">
                                    <figure className="image overlay-anim wow fadeInRight"><img src={aboutImage} alt="About" /></figure>
                                    <div className="icon-dots-3"></div>
                                    <div className="circle-text">
                                        <img src={circleTextIcon} alt="Circle Text Icon" />
