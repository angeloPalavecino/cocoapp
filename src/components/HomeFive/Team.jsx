                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-5">
                            <div className="text">
                                ...
                                for our Company. We have to a tendency to believe looking impression on visitors.
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="image-box">
                                <figure className="image">
                                    <Link to="/team-details">
                                        <img src={TeamImage1} alt="Jessica Brown" />
                                    </Link>
                                </figure>
                    ...
                    <div className="team-block col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="300ms">
                        <div className="inner-box">
                            <div className="image-box">
                                <figure className="image">
                                    <Link to="/team-details">
                                        <img src={TeamImage2} alt="Kevin Martin" />
                                    </Link>
                                </figure>
                                <div className="info-box">
                                    <h4 className="name">
                    ...
                    <div className="team-block col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="600ms">
                        <div className="inner-box">
                            <div className="image-box">
                                <figure className="image">
                                    <Link to="/team-details">
                                        <img src={TeamImage3} alt="Christine Eve" />
                                    </Link>
                                </figure>
                                <div className="info-box">
                                    <h4 className="name">
                    ...
                    <div className="team-block col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="900ms">
                        <div className="inner-box">
                            <div className="image-box">
                                <figure className="image">
                                    <Link to="/team-details">
                                        <img src={TeamImage4} alt="David Smith" />
                                    </Link>
                                </figure>
                                <div className="info-box">
                                    <h4 className="name">
