...
import ProductDetailsThumb1 from '../../assets/images/resource/testi-thumb-1.jpg';
import ProductDetailsThumb2 from '../../assets/images/resource/testi-thumb-2.jpg';
                            ...
                            <div className="tabs-content">
								...
								<div className="row clearfix">
									<div className="col-lg-6 col-md-6 col-sm-12 comment-column">
										<div className="single-comment-box">
											<div className="inner-box">
												<figure className="comment-thumb"><img src={ProductDetailsThumb1} alt="Product Thumb" /></figure>
												<div className="inner">
									...
									<div className="col-lg-6 col-md-6 col-sm-12 comment-column">
										<div className="single-comment-box">
											<div className="inner-box">
												<figure className="comment-thumb"><img src={ProductDetailsThumb2} alt="Product Thumb" /></figure>
												<div className="inner">
													<ul className="rating clearfix">
														<li><i className="fas fa-star"></i></li>
														<li><i className="fas fa-star"></i></li>
